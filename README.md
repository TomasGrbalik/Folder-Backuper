...
Installer packaging is scheduled for Milestone 10. Execution uses the durable queue, cancellation, retention, and startup-recovery workflow described in the [Milestone 6 acceptance checklist](docs/milestone-6-acceptance.md). Unattended scheduling and catch-up follow the [Milestone 7 acceptance checklist](docs/milestone-7-acceptance.md), and the operational monitoring and history interface follows the [Milestone 8 acceptance checklist](docs/milestone-8-acceptance.md). Email notifications remain scheduled for Milestone 9.
