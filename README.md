...
Installer packaging is scheduled for Milestone 10. See the [Milestone 4 acceptance checklist](docs/milestone-4-acceptance.md) for job lifecycle, source read-only, schedule, ownership, destination mutation, and NAS alias validation steps. Backup execution remains unavailable until the engine and durable execution workflows are implemented in Milestones 5 and 6.
